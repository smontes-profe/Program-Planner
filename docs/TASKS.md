...
- [P0][ ] Editar instrumento: el cálculo de porcentaje restante de un RA parece que se hace bien cuando aun queda porcentaje por cubrir, pero mal cuando ya está cubierto por encima del 100% (por ejemplo, veo que en PROG_SEV_2526_DAW_2_MAÑANA_DESCLI_061, el RA4 está al 140% y sin embargo no lo registra así si intento editar algún instrumento y asignar porcentaje  en ese RA).
